...
DELETE FROM person where email='test@gmail.com';

INSERT INTO `person` (`name`,`email`,`mobile_number`,`password`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin@gmail.com','3443434343','$2a$10$T4ctTzTUtoqUBcm7H1PXmu7JL25JJGZ6tQU1DQBZJcoyW7YmOVRP2', 1 ,CURDATE(),'DBA');