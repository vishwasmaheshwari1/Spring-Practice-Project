...
//if using spring mvc style of producing rest service
//then use @Controller
...
public class ContactRestController {
    ...
    public ResponseEntity<Response> saveMsg(@RequestHeader("invocationForm") String invocationForm, @Valid @RequestBody Contact contact) {
        ...
        log.info(String.format("Header Invocation = %s",invocationForm));
